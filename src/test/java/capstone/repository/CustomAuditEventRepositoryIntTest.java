...
import capstone.config.audit.AuditEventConverter;
import capstone.domain.PersistentAuditEvent;
...
import static capstone.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
