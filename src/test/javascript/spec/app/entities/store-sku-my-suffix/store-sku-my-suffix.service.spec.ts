...
describe('Service Tests', () => {
    ...
    describe('StoreSKUMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(StoreSKUMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/store-skus';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return StoreSKUMySuffix', () => {
